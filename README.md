...
За допомогою цієї утиліти можна скачати список користувачів які поставили лайк Вам на публікацію в Лінкедін. Для того щоб скачати весь список користувачів (в прикладі більше 600 користувачів які поставили лайки) Вам необхідно перейти на модальне вікно лайків поста та гортати в них до самого кінця списку, як тільки Ви будете в кінці списку відкривайте консоль та вставляйте цей скрипт         var linksLikes = document.querySelectorAll(
